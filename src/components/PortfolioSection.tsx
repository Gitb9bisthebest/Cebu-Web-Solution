  ...
  const portfolioItems = [
    {
      ...
      description: "A responsive landing page for a luxury mountain retreat resort",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?q=80&w=2070",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=2064",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=2070",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?q=80&w=1770",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1486718448742-163732cd1544?q=80&w=2070",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Browse through our latest projects showcasing our expertise in HTML/CSS/JS, 
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="html-css" className="mt-0">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {portfolioItems.filter(item => item.category === "html-css").map((item, index) => (
                <PortfolioItem key={index} {...item} />
              ))}
            </div>
          </TabsContent>
          ...
          <TabsContent value="shopify" className="mt-0">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {portfolioItems.filter(item => item.category === "shopify").map((item, index) => (
                <PortfolioItem key={index} {...item} />
              ))}
            </div>
          </TabsContent>
          ...
          <TabsContent value="webflow" className="mt-0">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {portfolioItems.filter(item => item.category === "webflow").map((item, index) => (
                <PortfolioItem key={index} {...item} />
              ))}
            </div>
          </TabsContent>
